...
describe('Get Weather', function() {
  ...
  it('with valid zip code', function() {
    ...
    assert(resMock.send.lastCall.args[0].city === 'Palmerston North', 'Unexpected response:' + resMock.send.lastCall.args[0].city);
    assert(resMock.send.lastCall.args[0].weather === 'Conditions are cold and temperature is 10.47 C', 'Unexpected response:' + resMock.send.lastCall.args[0].weather);
  });
});
